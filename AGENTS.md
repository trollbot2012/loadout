...
- skill authoring: invoke `superpowers:writing-skills`
...
- situational, gated multi-step work: invoke `unlazy`
- situational, diff review: invoke `ponytail:ponytail-review`
- situational, repeatable cycle: invoke `loopy`
- situational, self re-audit: invoke `loadout`
